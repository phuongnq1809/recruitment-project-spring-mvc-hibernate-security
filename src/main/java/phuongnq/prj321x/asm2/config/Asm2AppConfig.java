...
public class Asm2AppConfig implements WebMvcConfigurer {
	...
	public JavaMailSender getJavaMailSender()
	{
	    ...
	    mailSender.setUsername("quangphuongfunix@gmail.com");
	    mailSender.setPassword("hotskbbjdibrqhqv");
