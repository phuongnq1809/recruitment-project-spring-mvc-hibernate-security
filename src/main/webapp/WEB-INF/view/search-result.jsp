...
<title>QP Works Search Result</title>
</head>
<body>
	<!-- Header -->
				...
				<security:authorize access="hasRole('ROLE_USERS')">
					<div>
						...
						<security:authorize access="hasRole('ROLE_CONGTY')">
							...
							<a href="${employerListCandidateLink}" class="me-4 text-light">Ứng
								cử viên</a>
							<a
	...
	<section class="bg-main-title p-5">
		<div class="container">
			<h3 class="text-center text-white">KẾT QUẢ TÌM KIẾM</h3>
		</div>
	</section>
	...
	<section class="p-5">
		<div class="container">
			<c:choose>
				<c:when test="${theSearchResults.isEmpty()}">
					<h5 class="text-center">Không có kết quả phù hợp với tiêu chí
						tìm kiếm, vui lòng thử lại!</h5>
				</c:when>
				<c:otherwise>
					<!-- DataTales -->
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered tableCustomCss"
									...
									<!-- hien thi du lieu tu model "listRecruitments" -->
									<c:forEach var="tempRecruitment" items="${theSearchResults}"
										varStatus="vs">
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														...
														<p>
															<a href="${recruitmentDetailLink}" class="h5">${tempRecruitment.title}</a>
														</p>
													...
													<div class="d-flex justify-content-start">
														<div class="actions">
															<button type="button" class="btn btn-primary btn-sm"
																...
																data-bs-target="#applyJobModal${vs.index}">
																Apply Job</button>
																		...
																		<div class="modal-body">
																			...
																			<form:form
																				...
																				<div id="new-cv${vs.index}" style="display: none;">
																					<label for="" class="col-form-label">Chọn
																						CV:</label> <input id="new-cv-input${vs.index}"
																						name="selectCV" type="file"
