...
<html lang="en">
  ...
  <body>
    ...
    <section class="bg-main-title p-5">
      <div class="container">
        <h3 class="text-center text-white">XÁC THỰC EMAIL KHÔNG THÀNH CÔNG</h3>
      </div>
    </section>
    ...
    <section class="p-5">
      <div class="container">
        <h5 class="text-center">Rất xin lỗi bạn, chúng tôi không thể xác thực được tài khoản của bạn. Có thể bạn đã xác 
        thực trước đó hoặc mã xác thực không đúng, vui lòng thử lại! Trân trọng cảm ơn!</h5>
        <p class="text-center"><a href="${pageContext.request.contextPath}" class="btn btn-warning">Về trang chủ</a></p>
      </div>
    </section>
