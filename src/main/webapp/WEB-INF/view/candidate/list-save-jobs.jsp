...
<title>QP Works - List Saved Jobs</title>
</head>
<body>
	<!-- Header -->
	...
	<section class="bg-main-title p-5">
		<div class="container">
			<h3 class="text-center text-white">DANH SÁCH VIỆC LÀM ĐÃ LƯU</h3>
		</div>
	</section>
	...
	<section class="p-5">
		<div class="container">
			<c:choose>
				<c:when test="${theListSaveJobs == null}">
					<h4 class="text-center">Danh sách trống, bạn hãy chọn lưu công
						việc yêu thích!</h4>
				</c:when>
				<c:otherwise>
					<!-- DataTales -->
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered tableCustomCss"
									...
									<!-- hien thi du lieu tu model "theListSaveJobs" -->
									<c:forEach var="tempRecruitment" items="${theListSaveJobs}"
										varStatus="vs">
