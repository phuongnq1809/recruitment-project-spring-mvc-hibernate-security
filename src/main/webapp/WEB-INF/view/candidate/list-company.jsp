...
<title>QP Works - List Company</title>
</head>
<body>
	<!-- Header -->
	...
	<section class="bg-main-title p-5">
		<div class="container">
			<h3 class="text-center text-white">DANH SÁCH CÔNG TY HIỆN CÓ</h3>
		</div>
	</section>
				...
				<div class="card-body">
					<div class="table-responsive">
						<table class="table table-bordered tableCustomCss" id="dataTable"
							...
							<!-- hien thi du lieu tu model "listCompanies" -->
										...
										<div class="d-flex align-items-center">
											...
											<div>
												...
												<span class="fst-italic"> <i class="bi bi-building"></i>${tempCompany.email}
													<i class="bi bi-geo-alt ms-3"></i>${tempCompany.address} <i
													class="bi bi-currency-dollar ms-3 me-1"></i>${tempCompany.phoneNumber}
												</span>
											</div>
										</div>
									</td>
