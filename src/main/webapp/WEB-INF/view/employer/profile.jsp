...
<html lang="en">
  <head>
    ...
    <title>QP Works - Employer Profile</title>
    ...
    <section class="bg-main-title p-5">
      <div class="container">
        ...
        <p class="m-0 text-center">
          <c:choose>
          	<c:when test="${employerUpdate.image eq ''}">
          		<img
          	...
          	<c:otherwise>
          		<img
		            src="<c:url value="/resources/img-upload/${employerUpdate.image}" />"
		            width="100"
		            height="100"
		            class="rounded-circle"
		          />
      ...
      <div class="container px-5">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <form:form action="updateProfileProcess?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
            
            <h5>Thông tin cá nhân</h5>
            <p>Ảnh đại diện</p>
            <p class="m-0">
              <label for="img-input" class="img-input">Chọn ảnh</label>
              <input
                name="imgProfile"
                accept="image/*"
                type="file"
            ...
            <div class="card mt-3">
              <div class="card-body">
                  ...
                  <input type="hidden" name="userId" value="${employerUpdate.id}" />
                  
                  <div class="row">
                    <div class="col-12">
                      <label for="addemail" class="col-form-label"
                        >Email:</label
                      >
                      <input
                        type="email"
                    ...
                    <div class="col-12">
                      ...
                      <input
                        ...
                        id="phone"
                        name="phone"
                        value="${employerUpdate.phoneNumber}"
                        required
                      />
                    </div>
                    <div class="col-12">
                      <label for="" class="col-form-label"
                        >Mô tả bản thân:</label
                      >
                      <textarea
                        class="form-control"
                        name="userdesc"
                        placeholder="Hãy giới thiệu về bạn..."
                      >${employerUpdate.description}</textarea>
                    </div>
                  </div>
          ...
          <!-- Thong tin cong ty -->
          <div class="col-md-6">
          	<form:form action="updateCompanyProcess?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
          	
            <h5>Thông tin công ty</h5>
            <p>Cập nhật logo</p>
            <p class="m-0">
              <label for="logo-input" class="img-input">Chọn logo</label>
              <input
                name="imgLogo"
                accept="image/*"
                type="file"
              ...
              <br />
              <c:choose>
              	<c:when test="${companyUpdate.logo eq ''}">
              		<img
		                src="<c:url value="/resources/images/default-image.png" />"
		                width="75"
		                height="75"
              	...
              	<c:otherwise>
              		<img
		                src="<c:url value="/resources/img-upload/${companyUpdate.logo}" />"
		                width="75"
		                height="75"
		                id="logo-preview"
		                class="mt-2"
            ...
            <div class="card mt-3">
              <div class="card-body">
                ...
                <input type="hidden" name="companyId" value="${companyUpdate.id}" />
                
                  <div class="row">
                    <div class="col-12">
                      <label for="companyemail" class="col-form-label"
                        >Email:</label
                      >
                      <input
                        type="email"
                    ...
                    <div class="col-12">
                      <label for="companyaddress" class="col-form-label"
                        >Địa chỉ:</label
                      >
                      <input
                        type="text"
                    ...
                    <div class="col-12">
                      <label for="companyphone" class="col-form-label"
                      ...
                      <input
                        ...
                        id="companyphone"
                        name="companyphone"
                        value="${companyUpdate.phoneNumber}"
                        required
                      />
                    </div>
                    <div class="col-12">
                      ...
                      <textarea
                        class="form-control"
                        name="companydesc"
                        placeholder="Hãy giới thiệu về công ty..."
                      >${companyUpdate.description}</textarea>
                    </div>
                  </div>
